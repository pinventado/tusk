...
ALPINE_RELEASES="3"
PROJECT="tusk"
IMAGE_OWNER="${IMAGE_OWNER:-mshafae}"
...
push_docker_image () {
    ...
    docker tag ${_ID} ${IMAGE_OWNER}/${_TARGET}:${_DATE} || \
        echo "Failed docker tag ${_ID} ${IMAGE_OWNER}/${_TARGET}:${_DATE}"
    docker tag ${_ID} ${IMAGE_OWNER}/${_TARGET}:latest || \
        echo "Failed docker tag ${_ID} ${IMAGE_OWNER}/${_TARGET}:latest"

    docker push ${IMAGE_OWNER}/${_TARGET}:${_DATE} || \
        echo "Failed docker push ${IMAGE_OWNER}/${_TARGET}:${_DATE}"
    docker push ${IMAGE_OWNER}/${_TARGET}:latest || \
        echo "Failed docker push ${IMAGE_OWNER}/${_TARGET}:latest"
}
...
push_ghcr_image () {
    ...
    echo "${_TARGET} ${_ID} ${_DATE}"
    docker tag ${_ID} ghcr.io/${IMAGE_OWNER}/${_TARGET}:${_DATE} || \
        echo "Failed docker tag ${_ID} ghcr.io/${IMAGE_OWNER}/${_TARGET}:${_DATE}"
    docker tag ${_ID} ghcr.io/${IMAGE_OWNER}/${_TARGET}:latest || \
        echo "Failed docker tag ${_ID} ghcr.io/${IMAGE_OWNER}/${_TARGET}:latest"

    docker push ghcr.io/${IMAGE_OWNER}/${_TARGET}:${_DATE} || \
        echo "Failed docker push ghcr.io/${IMAGE_OWNER}/${_TARGET}:${_DATE}"
    docker push ghcr.io/${IMAGE_OWNER}/${_TARGET}:latest || \
        echo "Failed docker push ghcr.io/${IMAGE_OWNER}/${_TARGET}:latest"
}
